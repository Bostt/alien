...
TEST_F(MutationTests, neuronWeightMutation_keepOtherAttributesUnchanged)
{
    ...
    genome._mutations._neuronMutation1 = NeuronMutationDesc().probability(1.0f).weightSigma(1.0f);
    genome._mutations._neuronMutation2 = NeuronMutationDesc().probability(1.0f).weightSigma(1.0f);
...
TEST_F(MutationTests, neuronWeightMutation_weightsActuallyChange)
{
    auto genome = createTestGenome();
    genome._mutations._neuronMutation1 = NeuronMutationDesc().probability(1.0f).weightSigma(1.0f);
    genome._mutations._neuronMutation2 = NeuronMutationDesc().probability(0.0f).weightSigma(0.0f);
...
{
    auto genome = createTestGenome();
    genome._mutations._neuronMutation1 = NeuronMutationDesc().probability(0.0f).weightSigma(1.0f).biasSigma(1.0f);
    genome._mutations._neuronMutation2 = NeuronMutationDesc().probability(0.0f).weightSigma(1.0f).biasSigma(1.0f);
...
{
    auto genome = createTestGenome();
    genome._mutations._neuronMutation1 = NeuronMutationDesc().probability(1.0f).weightSigma(0.0f).biasSigma(1.0f);
    genome._mutations._neuronMutation2 = NeuronMutationDesc().probability(0.0f).weightSigma(0.0f).biasSigma(0.0f);
...
{
    auto genome = createTestGenome();
    genome._mutations._neuronMutation1 = NeuronMutationDesc().probability(1.0f).weightSigma(0.0f).biasSigma(0.0f);
    genome._mutations._neuronMutation2 = NeuronMutationDesc().probability(1.0f).weightSigma(0.0f).biasSigma(0.0f);
...
{
    auto genome = createTestGenome();
    genome._mutations._neuronMutation1 = NeuronMutationDesc().probability(1.0f).biasSigma(1.0f);
    genome._mutations._neuronMutation2 = NeuronMutationDesc().probability(1.0f).biasSigma(1.0f);
...
{
    auto genome = createTestGenome();
    genome._mutations._neuronMutation1 = NeuronMutationDesc().probability(1.0f).activationFunctionProbability(1.0f);
    genome._mutations._neuronMutation2 = NeuronMutationDesc().probability(0.0f).activationFunctionProbability(0.0f);
...
{
    auto genome = createTestGenome();
    genome._mutations._neuronMutation1 = NeuronMutationDesc().probability(1.0f).activationFunctionProbability(0.0f);
    genome._mutations._neuronMutation2 = NeuronMutationDesc().probability(1.0f).activationFunctionProbability(0.0f);
...
TEST_F(MutationTests, neuronActivationFunctionMutation_keepOtherAttributesUnchanged)
{
    auto genome = createTestGenome();
    genome._mutations._neuronMutation1 = NeuronMutationDesc().probability(1.0f).activationFunctionProbability(1.0f);
    genome._mutations._neuronMutation2 = NeuronMutationDesc().probability(1.0f).activationFunctionProbability(1.0f);
...
{
    auto genome = createTestGenome();
    genome._mutations._connectionMutationRate1 = ConnectionMutationDesc().probability(1.0f).sigma(1.0f);
    genome._mutations._connectionMutationRate2 = ConnectionMutationDesc().probability(0.0f).sigma(0.0f);
...
{
    auto genome = createTestGenome();
    genome._mutations._connectionMutationRate1 = ConnectionMutationDesc().probability(0.0f).sigma(1.0f);
    genome._mutations._connectionMutationRate2 = ConnectionMutationDesc().probability(0.0f).sigma(1.0f);
...
TEST_F(MutationTests, connectionWeightMutation_keepOtherAttributesUnchanged)
{
    auto genome = createTestGenome();
    genome._mutations._connectionMutationRate1 = ConnectionMutationDesc().probability(1.0f).sigma(1.0f);
    genome._mutations._connectionMutationRate2 = ConnectionMutationDesc().probability(1.0f).sigma(1.0f);
...
TEST_F(MutationTests, lineageMutation_lineageIdActuallyChanges)
{
    auto genome = createTestGenome();
    genome.lineageId(42);
    genome._mutations._lineageMutationProbability = 1.0f;
...
TEST_F(MutationTests, lineageMutation_zeroProbabilityNoChange)
{
    auto genome = createTestGenome();
    genome.lineageId(42);
    genome._mutations._lineageMutationProbability = 0.0f;
...
{
    auto genome = createTestGenome();
    genome._mutations._neuronMutation1 = NeuronMutationDesc().probability(0.5f).weightSigma(0.5f).biasSigma(0.5f).activationFunctionProbability(0.5f);
    genome._mutations._neuronMutation2 = NeuronMutationDesc().probability(0.5f).weightSigma(0.5f).biasSigma(0.5f).activationFunctionProbability(0.5f);
    ...
    bool anyChanged = actualGenome._mutations._neuronMutation1._probability != 0.5f || actualGenome._mutations._neuronMutation1._weightSigma != 0.5f
        || actualGenome._mutations._neuronMutation1._biasSigma != 0.5f || actualGenome._mutations._neuronMutation1._activationFunctionProbability != 0.5f
        || actualGenome._mutations._neuronMutation2._probability != 0.5f || actualGenome._mutations._neuronMutation2._weightSigma != 0.5f
        || actualGenome._mutations._neuronMutation2._biasSigma != 0.5f || actualGenome._mutations._neuronMutation2._activationFunctionProbability != 0.5f;
    EXPECT_TRUE(anyChanged);

    EXPECT_GE(actualGenome._mutations._neuronMutation1._probability, 0.0f);
    EXPECT_GE(actualGenome._mutations._neuronMutation1._weightSigma, 0.0f);
    EXPECT_GE(actualGenome._mutations._neuronMutation1._biasSigma, 0.0f);
    EXPECT_GE(actualGenome._mutations._neuronMutation1._activationFunctionProbability, 0.0f);
    EXPECT_GE(actualGenome._mutations._neuronMutation2._probability, 0.0f);
    EXPECT_GE(actualGenome._mutations._neuronMutation2._weightSigma, 0.0f);
    EXPECT_GE(actualGenome._mutations._neuronMutation2._biasSigma, 0.0f);
    EXPECT_GE(actualGenome._mutations._neuronMutation2._activationFunctionProbability, 0.0f);
}
...
TEST_F(MutationTests, metaMutation_neuronRatesZeroSigmaNoChange)
{
    ...
    EXPECT_EQ(actualGenome._mutations._neuronMutation1._probability, 0.5f);
    EXPECT_EQ(actualGenome._mutations._neuronMutation1._weightSigma, 0.5f);
    EXPECT_EQ(actualGenome._mutations._neuronMutation1._biasSigma, 0.5f);
    EXPECT_EQ(actualGenome._mutations._neuronMutation1._activationFunctionProbability, 0.5f);
    EXPECT_EQ(actualGenome._mutations._neuronMutation2._probability, 0.5f);
    EXPECT_EQ(actualGenome._mutations._neuronMutation2._weightSigma, 0.5f);
    EXPECT_EQ(actualGenome._mutations._neuronMutation2._biasSigma, 0.5f);
    EXPECT_EQ(actualGenome._mutations._neuronMutation2._activationFunctionProbability, 0.5f);
}

TEST_F(MutationTests, metaMutation_connectionRatesActuallyChange)
{
    auto genome = createTestGenome();
    genome._mutations._connectionMutationRate1 = ConnectionMutationDesc().probability(0.5f).sigma(0.5f);
    genome._mutations._connectionMutationRate2 = ConnectionMutationDesc().probability(0.5f).sigma(0.5f);
    ...
    bool anyChanged = actualGenome._mutations._connectionMutationRate1._probability != 0.5f || actualGenome._mutations._connectionMutationRate1._sigma != 0.5f
        || actualGenome._mutations._connectionMutationRate2._probability != 0.5f || actualGenome._mutations._connectionMutationRate2._sigma != 0.5f;
    EXPECT_TRUE(anyChanged);
    EXPECT_GE(actualGenome._mutations._connectionMutationRate1._probability, 0.0f);
    EXPECT_GE(actualGenome._mutations._connectionMutationRate1._sigma, 0.0f);
    EXPECT_GE(actualGenome._mutations._connectionMutationRate2._probability, 0.0f);
    EXPECT_GE(actualGenome._mutations._connectionMutationRate2._sigma, 0.0f);
}
...
TEST_F(MutationTests, metaMutation_connectionRatesZeroSigmaNoChange)
{
    ...
    EXPECT_EQ(actualGenome._mutations._connectionMutationRate1._probability, 0.5f);
    EXPECT_EQ(actualGenome._mutations._connectionMutationRate1._sigma, 0.5f);
    EXPECT_EQ(actualGenome._mutations._connectionMutationRate2._probability, 0.5f);
    EXPECT_EQ(actualGenome._mutations._connectionMutationRate2._sigma, 0.5f);
}

TEST_F(MutationTests, metaMutation_lineageProbabilityActuallyChanges)
{
    auto genome = createTestGenome();
    genome._mutations._lineageMutationProbability = 0.5f;
    ...
    EXPECT_NE(actualGenome._mutations._lineageMutationProbability, 0.5f);
}
...
TEST_F(MutationTests, metaMutation_lineageProbabilityZeroSigmaNoChange)
{
    ...
    EXPECT_EQ(actualGenome._mutations._lineageMutationProbability, 0.5f);
    EXPECT_GE(actualGenome._mutations._lineageMutationProbability, 0.0f);
}
